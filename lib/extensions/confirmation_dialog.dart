              ...
              children: [
                imageShow ??
                    Container(
                      ...
                      decoration: boxDecorationWithRoundedCorners(borderRadius: radius(150), backgroundColor: bgColor ?? primaryVariant),
                    ...
                    Row(
                      children: [
                        AppButton(
                          ...
                          child: Text(negativeText ?? language.cancel, style: boldTextStyle(color: negativeTextColor ?? primaryColor)).fit(),
                          onTap: () {
                        ...
                        AppButton(
                          height: 30,
                          elevation: 0,
                          color: getDialogPrimaryColor(_, dialogType, positiveBg ?? primaryColor),
                          child: Text(positiveText ?? getPositiveText(dialogType), style: boldTextStyle(color: positiveTextColor ?? Colors.white)).fit(),
                          onTap: () {
                            onAccept.call(_);
