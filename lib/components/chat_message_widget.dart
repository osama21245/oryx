      ...
      children: [
        Container(
          ...
          decoration: boxDecorationDefault(
            color: appStore.isDarkModeOn ? context.cardColor : context.dividerColor.withOpacity(0.4),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.copy, size: 16, color: appStore.isDarkModeOn ? Colors.white : primaryColor),
                    ).onTap(() {
